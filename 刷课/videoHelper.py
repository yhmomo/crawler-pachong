...
sessionid = "m6crihe9weqqf5etuo2av8cec16xwtaj"
...
if __name__ == "__main__":
    ...
    # 然后要获取教室id
    get_classroom_id = "https://nbufe.yuketang.cn/mooc-api/v1/lms/user/user-courses/?status=1&page=1&no_page=1&term=latest&uv_id=3078"
    submit_url = "https://nbufe.yuketang.cn/mooc-api/v1/lms/exercise/problem_apply/?term=latest&uv_id=3078"

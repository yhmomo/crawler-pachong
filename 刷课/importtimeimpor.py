...
csrftoken = "APJ4pDs4ZCpAgT2Eu0qhcC2BDtqXcm5y"  # 需改成自己的
sessionid = "m6crihe9weqqf5etuo2av8cec16xwtaj"  # 需改成自己的

# 对单个课程的 video helper
user_id = "44927338"  # 需改成自己的
sku_id = "7485477"  # 需改成自己的
course_id = "3996036"  # 需改成自己的
course_name = ""  # 需改成自己的
...
headers = {
    ...
    'Cookie': 'university_id=3037; platform_id=3; xtbz=cloud; platform_type=1; csrftoken=APJ4pDs4ZCpAgT2Eu0qhcC2BDtqXcm5y; sessionid=m6crihe9weqqf5etuo2av8cec16xwtaj',
...
def one_video_watcher(video_id, video_name, cid, user_id, classroomid, skuid):
    ...
    get_url = "https://nbufe.yuketang.cn/video-log/detail/?cid=" + str(
...
if __name__ == "__main__":
    ...
    # 然后要获取教室id
    get_classroom_id = 'https://nbufe.yuketang.cn/video-log/get_video_watch_progress/?cid=3996036&user_id=44927338&classroom_id=16079046&video_type=video&vtype=rate&video_id=31384510&snapshot=1&term=latest&uv_id=3037'
